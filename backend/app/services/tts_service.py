...
class TTSService:
    ...
    WELCOME_TEXT = (
        "أَهْلاً وسَهْلاً فيكْ بِبوت لَيون دِليفِري بْصَيدا! "
    ...
    ORDER_COMPLETE_TEXT = (
        "أَلْف صَحّة وهَنا مِن لَيون بوت دِليفِري! "
        "مَطْرَح ما يِصير يِمَرّي! بِدْنا نْشوفَك كِلّ يَوم عَم تِطْلُب مِن عِنْدنا. "
        "وإِذا في شي ما عَجَبَك، فيكْ تِتْواصَل مَع مَكْتَبنا وتِحْكيلنا."
    )
