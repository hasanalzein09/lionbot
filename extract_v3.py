...
def extract_restaurants_from_md(filepath):
    """Extract restaurant data from markdown file"""
    ...
    for i in range(1, len(parts)):
        ...
        # Extract menu JSON by counting braces
        brace_count = 0
        in_string = False
        escape_next = False
        menu_json = ""
...
def main():
    ...
    try:
        ...
        restaurants = extract_restaurants_from_md("/Users/hasanelzein/Desktop/lionbot/res.md")
    ...
    try:
        ...
        restaurants = extract_restaurants_from_md("/Users/hasanelzein/Desktop/lionbot/admin_app/rest2.md")
    ...
    with open(output_file, 'w', encoding='utf-8') as f:
        ...
        for rest in all_restaurants:
            f.write(format_restaurant(rest))
